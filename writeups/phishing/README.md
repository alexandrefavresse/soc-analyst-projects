...
The phishing analysis report present in this repo was made during an homemade lab and is presented as a simulation of a real phishing report that a SOC Analyst would write after an alert. For this purpose, I used a real phishing sample from https://github.com/rf-peixoto/phishing_pot (sample-1261.eml) to keep the simulation as realistic as possible. The recipient address has been masked to keep their anonymity. The goal of this exercice is to practice my analysis and reporting skills in an environment as realistic as possible, as writing report is an important part of a SOC Analyst duty and I chose a phishing sample because phishing represent the main attack vector for initial access (MITRE ATT&CK - T1566). 

# Scenario

It's 13:00, lunch is over and an alert appears in the company's SIEM, Alexandre, a junior SOC Analyst takes 
...
I noticed that the file attached had a double extension and I used the commandline on Kali Linux to extract the SHA256 hash of the attached file to later on analyse it on VirusTotal and Hybrid Analysis. 
The file was categorized as malicious on both websites and I gathered information about the type of malware that was used for the attack (Beluga) and I was able to see a preview of the opened file on Hybrid Analysis, which helped to understand what kind of phishing attack it was and it lead my to think that it was a credential harvesting attack. 
